                ...
                <section className="sobre-nos-content">
                    ...
                    <section className="about-text-column">
                            <p className="sobre-nos-paragraph">
                                ...
                                e exercícios referentes ao tema da aula escolhida. Para fazer a integração da IA Generativa configuramos a 
                                API Gemini no Back-End (Node.JS) onde criamos um "Especialista" a partir do sistema Prompt Engineering. No 
                                Front-End utilizamos React com Html/Css/JavaScript. Durante todo o processo utilizamos o Trello, uma ferramenta 
                                de gestão visual de projetos, para organizarmos nossas entregas e dividir as atividades para cada integrante.
                            </p>
                        </section>
